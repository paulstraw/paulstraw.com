...
<template>
  <div>
    ...
    <div class="post-content">
      <p>
        In some ways, I started this project back in 2015, though the final form didn't come to me until late 2019.
      </p>
      <figure>
        <img
          src="/img/metalamp/x.jpg"
          title="MetaLamp"
        />
        <figcaption>
          A completed MetaLamp …but we'll get into that in a bit.
        </figcaption>
      </figure>
      ...
      <responsive-figure position="left">
        <video
          playsinline
          controls
          src="https://paulstraw.s3.amazonaws.com/metalamp/overhead-light-upgrade.mp4"
          poster="/video/metalamp/wip-octopus-lighting.jpg"
        ></video>
        <figcaption>
          Some early footage from the strip that was going to light the Octopus sign. It was a <em>big</em> sign.
        </figcaption>
      </responsive-figure>
      ...
      <p>In total, MetaLamp has 56 WS2812B packages in it (168 total LEDs, accounting for the individual red, green, and blue LEDs in each package). I also added a capacitive power button to quickly toggle it on and off without having to open the companion app.</p>
